...
class Doorbell():
    ...
    def reboot_device(self):
        # TODO: catch error from SDK NET_DVR_NETWORK_RECV_TIMEOUT, since the device is rebooting
        return self._call_isapi("PUT", "/ISAPI/System/reboot")
    ...
    def _call_isapi(self, http_method: str, url: str, requestBody: str = "") -> str:
        ...
        if not result:
            ...
            raise RuntimeError("Error while calling ISAPI endpoint")
