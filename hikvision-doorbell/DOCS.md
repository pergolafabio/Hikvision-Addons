...
- Device triggers
  ...
  The _device triggers_ are used to signal alarms and events generated by the doorbells (e.g. tamper alarm, door not open, etc..). 
  ...
  **NOTE**: The device triggers are discovered *once the associated event is triggered on the device at least once.*
  ...
  To use a device trigger in an automation you can follow the steps below, after having selected a doorbell from the `Device` page in HA. For more information, see the [HA documentation](https://www.home-assistant.io/docs/automation/trigger/#device-triggers).
  
  <p align="center">
    <img src="assets/docs_device_triggers.png" width="700px" />
  </p>
